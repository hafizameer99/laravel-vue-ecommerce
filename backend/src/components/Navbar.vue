<template>
    <header class="flex justify-between items-center p-3 h-14 shadow bg-white">
        <button
            ...
            class="flex items-center justify-center w-8 h-8 rounded transition-colors text-gray-700 hover:bg-black/10"
        >
            <MenuIcon class="w-6" />
        </button>
        <Menu as="div" class="relative inline-block text-left">
            <MenuButton class="flex items-center">
                ...
                <ChevronDownIcon
                    class="h-7 w-6 text-indigo-300 hover:text-indigo-200"
                    aria-hidden="true"
                />
            </MenuButton>
